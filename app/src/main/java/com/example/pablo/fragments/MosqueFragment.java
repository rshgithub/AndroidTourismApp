...
public class MosqueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(popularMosquesAdapter);
        recyclerView2.setAdapter(mosqueAdapter);
    ...
    private void getMosque() {
        ...
        service.getMosques("Bearer " + token).enqueue(new Callback<List<Data>>() {
            @Override
